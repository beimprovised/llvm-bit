...
CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_INSTALL_PREFIX:PATH=\"$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH\" "	#$CMAKE -DCMAKE_INSTALL_PREFIX:PATH=$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH \
...
CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_C_COMPILER:FILEPATH=\"$CC\" "
CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_CXX_COMPILER:FILEPATH=\"$CPP\" "
...
CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_ASM_COMPILER:FILEPATH=\"$CC\" "
...
CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_CXX_LINK_FLAGS:STRING=\"-l${LIBCXX_PREIFX}c++ -latomic -L${ATOMIC_PATH} -L$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH/lib -Wl,-rpath=$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH/lib\" " # -lc++abi
#CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_CXX_LINK_FLAGS:STRING=\"-l${LIBCXX_PREIFX}c++ -latomic -L${ATOMIC_PATH} -L$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH/lib\" " # -lc++abi
CMAKE_COMMAND=$CMAKE_COMMAND"-DLIBOMP_USE_QUAD_PRECISION:BOOL=\"FALSE\" "
#`#-DCMAKE_ASM_COMPILER:FILEPATH=/usr/bin/cc` \	#comment in concated string divided by \\
...
CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_CXX_FLAGS:STRING=\"-std=c++11 -stdlib=lib${LIBCXX_PREIFX}c++ -I$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH/lib/clang/$CLANG_MAIN_VERSION.0.0/include -I$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH/include/c++/v1\" "
...
CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_CXX_LINK_FLAGS:STRING=\"-l${LIBCXX_PREIFX}c++ -lc++abi -latomic -L$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH/lib -L${ATOMIC_PATH} -Wl,-rpath=$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH/lib\" "
#CMAKE_COMMAND=$CMAKE_COMMAND"-DCMAKE_CXX_LINK_FLAGS:STRING=\"-l${LIBCXX_PREIFX}c++ -lc++abi -latomic -L$WORKING_PATH/$INSTALL_PATH_PREFIX-$RELATIVE_SOURCE_PATH/lib -L${ATOMIC_PATH}\" "
