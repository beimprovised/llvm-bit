...
if ! [ "$WORKING_PATH"  = "" ]; then
	...
	if [ ! -d "$WORKING_PATH/$LLVM_SOURCE_ROOT" ]; then
		git clone https://beimprovised@github.com/beimprovised/llvm-dev $LLVM_SOURCE_ROOT	# git clone http://llvm.org/git/llvm.git
	fi;
	...
	if [ ! -d ".git" ]; then
		...
		git remote add origin https://beimprovised@github.com/beimprovised/llvm-dev
...
#	fi;
	...
	if [ ! -d "$WORKING_PATH/$LLVM_SOURCE_ROOT/tools/clang" ]; then
		git clone https://beimprovised@github.com/beimprovised/clang-dev clang	# http://llvm.org/git/clang.git
	fi;
	cd clang
	if [ ! -d ".git" ]; then
		git remote add official http://llvm.org/git/clang.git
		git remote add origin https://beimprovised@github.com/beimprovised/clang-dev
...
#
	...
	if [ ! -d "$WORKING_PATH/$LLVM_SOURCE_ROOT/projects/compiler-rt" ]; then
		git clone https://beimprovised@github.com/beimprovised/compiler-rt-dev compiler-rt	# http://llvm.org/git/compiler-rt.git
	fi;
	cd compiler-rt
	if [ ! -d ".git" ]; then
		git remote add official http://llvm.org/git/compiler-rt.git
		git remote add origin https://beimprovised@github.com/beimprovised/compiler-rt-dev
...
#	fi;
	...
	if [ ! -d "$WORKING_PATH/$LLVM_SOURCE_ROOT/projects/openmp" ]; then
		git clone https://beimprovised@github.com/beimprovised/openmp-dev openmp	# http://llvm.org/git/openmp.git
	fi;
	cd openmp
	if [ ! -d ".git" ]; then
		git remote add official http://llvm.org/git/openmp.git
		git remote add origin https://beimprovised@github.com/beimprovised/openmp-dev
